...
import { hasBottomNavigation } from './floatingButtonLayout'
...
function FloatingChatButton() {
  ...
  // 하단 내비게이션이 있는 화면에서는 버튼을 내비 위로 올린다. (floatingButtonLayout.ts)
  const sitsAboveNavigation = hasBottomNavigation(pathname)
