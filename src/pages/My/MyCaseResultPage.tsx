    ...
    <main className="my-case-result-page my-detail-slide-enter">
      ...
      <div className="my-case-result-page__content" role="region" aria-label="사건 결과 상세 내용" tabIndex={0}>
        <section className="my-result-summary">
          <span className={isJihoon ? 'is-private' : undefined}>{isSeoa ? '투표 완료' : '나만 보기 · AI 1심 완료'}</span>
        ...
        <section className="ai-verdict-card">
          ...
          {isSeoa ? <div><span>AI 판단 확신도</span><b>66%</b></div> : <div><span>작성한 내용에 기반한 참고 의견이에요.</span></div>}
        </section>

        {isSeoa && <section className="jury-verdict-card">
          <h3>배심원 2심 결과</h3>
